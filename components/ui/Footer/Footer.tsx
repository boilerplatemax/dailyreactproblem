...
export default function Footer() {
  return (
    <footer className="mx-auto max-w-[1920px] px-6 bg-blue-900">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 border-b border-zinc-600 py-12 text-white transition-colors duration-150 bg-blue-900">
      ...
      <div className="py-12 flex flex-col md:flex-row justify-between items-center space-y-4 bg-blue-900">
        <div>
          <span>&copy; 2023 ReactTeacher, Inc. All rights reserved.</span>
        </div>
