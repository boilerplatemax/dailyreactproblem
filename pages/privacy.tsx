    ...
    <div className="2xl:px-48 py-3 px-4 min-h-screen">
      <div className="grid grid-cols-1 gap-x-12  animate-[fadeIn_1s_ease-in-out]">
        ...
        <p className="text-lg mb-4">
          This privacy policy ("Policy") describes how [Company Name] and its
          affiliates ("we", "us", or "our") collect, use, and share information
          about you when you use our website, mobile application, or other
          online products or services (collectively, the "Services").
        </p>

        <p className="text-lg mb-4">
          Please read this Policy carefully to understand our policies and
          practices regarding your information and how we will treat it. If you
          do not agree with our policies and practices, do not use the Services.
          By accessing or using the Services, you agree to this Policy. This
        ...
        <ul className="list-disc mb-4">
          <li className="text-lg">
            ...
            address, e-mail address, or phone number ("personal information").
          </li>
          <li className="text-lg">
        ...
        <ul className="list-disc mb-4">
          ...
          <li className="text-lg">
            Communicate with you, including by sending you promotional
            information about products and services that we think may be of
            interest to you.
          </li>
          <li className="text-lg">
            Personalize your experience on the Services by presenting products
        ...
        <p className="text-lg mb-4">
          We may disclose information about you to the following parties:
        </p>
        ...
        <ul className="list-disc mb-4">
          ...
          <li className="text-lg">
            Government and law enforcement agencies, to the extent required by
            law.
          </li>
        </ul>

        <p className="text-lg mb-4">
          We may also disclose information about you in connection with the
          sale, merger, or reorganization of our business.
        </p>
        ...
        <p className="text-lg mb-4">
          ...
          information transmitted to the Services. Any transmission of personal
        ...
        <p className="text-lg mb-4">
          ...
          on the Services and hold certain information.
        </p>

        <p className="text-lg mb-4">
          Cookies are small data files that are placed on your computer or
          mobile device when you visit a website or app. They are widely used to
        ...
        <p className="text-lg mb-4">
          ...
          you may not be able to use some features of the Services.
        </p>

        <p className="text-lg mb-4">
          We may also use web beacons, pixels, and other tracking technologies
          on the Services to help customize the Services and improve your
          experience. Web beacons are electronic images that may be used on the
          Services or in emails we send to you. We may use web beacons to
        ...
        <p className="text-lg mb-4">
          ...
          Analytics, to collect information about your usage of the Services.
          These third-party analytics services may use cookies and other
          tracking technologies to help us analyze how users use the Services.
          The information collected by these third-party analytics services is
          subject to the privacy policies of these service providers.
        </p>

        <h2 className="text-xl font-bold mb-4">Links to Other Websites</h2>

        <p className="text-lg mb-4">
          The Services may contain links to other websites that are not operated
        ...
        <p className="text-lg mb-4">
          ...
          encourage you to review the Policy whenever you access the Services or
