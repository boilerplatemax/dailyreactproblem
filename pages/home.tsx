...
const home = (props: Props) => {
  return (
      ...
      <div className="container mx-auto">
        <div className="flex flex-wrap -mx-4">
          <div className="w-full lg:w-2/4 px-4 mb-8 lg:mb-0">
            <h1 className="text-4xl font-bold text-white mb-5">Welcome to React Teacher!</h1>
            <p className="text-lg leading-relaxed text-white mb-8">
            We believe that the best way to <b>learn</b> is by doing, and our questions provide an opportunity for you to apply your knowledge and see <b>immediate results</b>. Each day, you'll receive a new question to solve, allowing you to consistently challenge and improve your skills.
    ...
    <div>
    <h2 className="text-4xl font-bold text-white mb-5">What you get from us:</h2>
    <ul className='mb-8 text-lg font-light text-white'>
  <li className='mb-2'>
    <i className="fas fa-check-circle mr-2 text-green-500 w-5 h-5"></i> Access to all previous questions & solutions
  </li>
  <li className='mb-2'>
    <i className="fas fa-check-circle mr-2 text-green-500 w-5 h-5"></i> Detailed explanations of each solution
  </li>
  <li className='mb-2'>
    <i className="fas fa-check-circle mr-2 text-green-500 w-5 h-5"></i> Interactable code solutions in Codepen
  </li>
  <li className='mb-2'>
    <i className="fas fa-check-circle mr-2 text-green-500 w-5 h-5"></i> Get a month's worth of daily React challenges for the price of a coffee!
  </li>
</ul>

    <h2 className="text-xl font-bold text-white mb-5">Example solution:</h2>
...
The component also has a div element with the class name "qr-holder". If the qrUrl state variable is truthy (i.e., not an empty string), the div element will render an img element with the src attribute set to the value of the qrUrl state variable.</p>
     */}
    <iframe height="600" style={{width:'100%'}} scrolling="no" title="QR Code (solution)" src="https://codepen.io/reactteacher/embed/zYLrYRE?default-tab=css%2Cresult&editable=true"  loading="lazy">
  See the Pen <a href="https://codepen.io/reactteacher/pen/zYLrYRE">
  QR Code (solution)</a> by Max (<a href="https://codepen.io/reactteacher">@reactteacher</a>)
  on <a href="https://codepen.io">CodePen</a>.
    ...
    <div className="bg-transparent py-12">
      <div className="lg:flex flex-row lg:flex-row-reverse">
        ...
        <div className="lg:w-1/2">
        <h2 className="text-4xl font-bold text-white mb-5">Elevate Your React Skills</h2>
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap -mx-4">
          <div className="w-full lg:w-1/3 px-4 mb-8">
            ...
            <h2 className="text-gray-600 text-xl leading-relaxed mb-2 font-semibold">A Lifesaver for <span className="text-orange-500 font-bold">University Students</span></h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-4 text-zinc-500">
              "The variety of questions and explanations provided solidified my understanding of the concepts and allowed me to confidently apply them in my projects."
              </p>
          ...
          <div className="w-full lg:w-1/3 px-4 mb-8">
            <div className="bg-white rounded-lg shadow-lg p-4">
            <h2 className="text-gray-600 text-xl leading-relaxed mb-2 font-semibold">The Perfect Resource for <span className="text-orange-500 font-bold">Career Switchers</span></h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-4 text-zinc-500">
              "The concise, clear explanations helped me grasp the concepts quickly and efficiently, and I am now confident in my React skills."
              </p>
              <div className="text-zinc-900 text-sm mb-2">
                Zara Patel
                </div>
          ...
          <div className="w-full lg:w-1/3 px-4 mb-8">
            <div className="bg-white rounded-lg shadow-lg p-4">
              <h2 className="text-gray-600 text-xl leading-relaxed mb-2 font-semibold">A Must-Have for Self Taught <span className="text-orange-500 font-bold">Web Developers</span></h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-4 text-zinc-500">
              "ReactTeacher has been a game-changer for me. It's packed with valuable information and exercises that have helped me improve my skills and become more proficient in React."
              </p>
              <div className="text-zinc-900 text-sm mb-2">
                James Rodriguez
                </div>
