     ...
     */}
        <div className="relative">
          ...
          >
            ...
            by Max (<a href="https://codepen.io/reactteacher">@reactteacher</a>)
        ...
        <div className="lg:flex flex-row lg:flex-row-reverse">
          ...
          <div className="lg:w-1/2">
            ...
            <p className="text-white text-lg">
              ...
              practice. Subscribe to our service to start learning and improving
              today by getting detailed explanations and solutions.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full lg:w-1/3 px-4 mb-8">
              <div className="bg-white rounded-lg shadow-lg p-4">
                ...
                <p className="text-gray-600 text-lg leading-relaxed mb-4 text-zinc-500">
                  "The variety of questions and explanations provided solidified
                  my understanding of the concepts and allowed me to confidently
                  apply them in my projects."
                </p>
            ...
            <div className="w-full lg:w-1/3 px-4 mb-8">
              <div className="bg-white rounded-lg shadow-lg p-4">
                ...
                <p className="text-gray-600 text-lg leading-relaxed mb-4 text-zinc-500">
                  "The concise, clear explanations helped me grasp the concepts
                  quickly and efficiently, and I am now confident in my React
                  skills."
                </p>
